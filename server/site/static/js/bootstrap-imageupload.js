...
(function($) {
    ...
    function resetFileTab($fileTab) {
        ...
        $fileTab.find('img').attr("src", "img/upload.png");
        ...
        isValidImageFile(file, function(isValid, message) {
            if (isValid) {
                ...
                fileReader.onload = function(e) {
                    ...
                    // var width = $fileTab.find('img').width();
                    var height = $fileTab.find('img').height();
                    $fileTab.find('img')
                ...
                fileReader.onerror = function() {
                    $fileTab.append(getAlertHtml('Error loading image file.'));
                    $fileInput.val('');
                };
                ...
                $fileTab.append(getAlertHtml(message));
                $browseFileButton.find('span').text('Browse');
                $fileInput.val('');
            }
    ...
    function submitImageUrl($urlTab) {
        ...
        if (!url) {
            $urlTab.append(getAlertHtml('Please enter an image URL.'));
            return;
        }
        ...
        isValidImageUrl(url, function(isValid, message) {
            if (isValid) {
                ...
                $urlTab.append(getAlertHtml(message));
            }
